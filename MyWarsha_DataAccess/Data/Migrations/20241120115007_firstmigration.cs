        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ColorLight = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ColorDark = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductsRestockingBillId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ProductsRestockingBillId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Car_CarGeneration_CarGenerationId",
            ...
            migrationBuilder.InsertData(
                table: "ServiceStatus",
                columns: new[] { "Id", "ColorDark", "ColorLight", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "#854d0e", "#fef9c3", null, "Pending" },
                    { 2, "#075985", "#e0f2fe", null, "InProgress" },
                    { 3, "#166534", "#dcfce7", null, "Done" },
                    { 4, "#991b1b", "#fecaca", null, "Canceled" }
                });
